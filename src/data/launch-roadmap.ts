...
export const launchRoadmap: RoadmapPhase[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "10.05", title: "Publish GitHub Pages preview", description: "Push the static export and verify the temporary GitHub Pages URL.", status: "done" },
      { id: "10.06", title: "Domain plan", description: "Choose and document the launch domain.", status: "current" },
